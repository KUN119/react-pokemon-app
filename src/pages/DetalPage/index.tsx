...
import { FlavorTextEntry, PokemonDescription } from '../../types/PokemonDescriptions';
...
export default function DetailPage() {
    ...
    const formatPokemonAbilities = (abilities: Ability[]) => {
        return abilities.filter((_, index) => index <= 1)
            .map((obj: Ability) => obj.ability.name.replace(/-/g, ' '))
    }
    ...
    return (
        <>
            {pokemon &&
                <article className='flex items-center gap-1 flex-col w-ful'>
                <div
                    className={
                    ...
                    <section className='w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4'>
                        ...
                        <div className='flex w-full items-center justify-between'>
                            <div className='w-full'>
                                <h4 className='flex justify-center text-[.6rem] text-indigo-100'> Weight</h4>
                            ...
                            <div className='w-full'>
                                <h4 className='flex justify-center text-[.6rem] text-indigo-100'> Height</h4>
                                <div className='text-sm flex mt-1 gap-2 justify-center text-zinc-200'>
                                    <Vector />
                                    {pokemon.height}m
                                </div>
                            ...
                            <div className='w-full'>
                                <h4 className='flex justify-center text-[.6rem] text-indigo-100'> Ability</h4>
                                    {pokemon.abilities.map((ability) => (
                                        <div key={ability} className='text-[0.5rem] flex justify-center text-zinc-100 capitalize'>{ ability }</div>
                                    ))}
                            </div>
                        </div>
